...
class Berita extends CI_Controller {
	...
	public function files()	{
		...
		$data = array(	'title'			=> 'Download',
						'download'		=> $download);
		$this->load->view('member/berita/files', $data, FALSE);		
	}
	...
	public function gambar()	{
		...
		$data = array(	'title'			=> 'Galeri',
						'galeri'		=> $galeri);
		$this->load->view('member/berita/gambar', $data, FALSE);		
	}
	...
	public function proses()
	{
		...
		if(isset($_POST['hapus'])) {
			...
			$id_beritanya		= $inp->post('id_berita');
   			...
   			redirect(base_url('member/berita'),'refresh');
	...
	public function tambah()	{
		...
		// Masuk database
	        ...
	        redirect(base_url('member/berita/jenis_berita/'.$i->post('jenis_berita')),'refresh');
		}}else{
			$i 		= $this->input;
	        $slug 	= url_title($i->post('judul_berita'),'dash',TRUE);
...
/* Location: ./application/controllers/member/Berita.php */
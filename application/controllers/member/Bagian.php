...
class Bagian extends CI_Controller {
	...
	public function tambah()
	{
		...
		// Masuk ke database
			...
			redirect(base_url('member/bagian'),'refresh');
		}
		// End masuk database
	}
...
/* Location: ./application/controllers/member/Bagian.php */
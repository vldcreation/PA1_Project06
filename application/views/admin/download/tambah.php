...
<input type="text" name="judul_download" required class="form-control" placeholder="Judul download" value="<?php echo set_value('judul_download') ?>">
</div>
...
<select required name="jenis_download" class="form-control">
...
<select required name="id_kategori_download" class="form-control">
...
<textarea required="required" name="isi" id="isi" class="form-control" placeholder="Isi download"><?php echo set_value('isi') ?></textarea>
</div>

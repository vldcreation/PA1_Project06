...
<head>
    ...
    <title><?= $site->namaweb?> - Member Area Login</title>
    <meta charset="UTF-8">
    ...
    <div id="app">
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                    ...
                    if($this->session->flashdata('session_habis')) { 
                      ...
                      ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password" tabindex="4"
                                    >
                            </div>
                            <br>
                            <div class="form-group text-right">
                                <button type="submit" class="btn btn-block btn-info btn-lg btn-icon icon-right"
                                    tabindex="4">
                                    Masuk
                                </button>
                            </div>
               ...
               Belum Punya Akun?<a style="margin-left: 10px" href="<?php echo base_url('registrasi'); ?>" class="btn btn-info btn-sm"><i class="fa fa-arrow-user"></i> Daftar Akun</a>
              <a style="margin-left: 10px" href="<?php echo base_url('registrasi/reset_password'); ?>" class="btn btn-info btn-sm"><i class="fa fa-arrow-user"></i> Lupa Password ?</a>
          </div>
          </div>
                            <?php echo form_close(); ?>
                    </div>
...
<?php if($this->session->flashdata('verifagain')) { ?>
<script>
   Swal.fire({
   title: '<strong>Akun belum aktif</strong>',
   icon: 'warning',
   html:`Akun kamu belum aktif.Silahkan verifikasi terlebih dahulu.`,
   ...
   if (result.value) {
     window.location.href = `<?php echo base_url('loginmember/resend_activation'); ?>`
   }
 });
</script>
<?php } ?>

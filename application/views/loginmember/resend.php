...
<head>
    ...
    <title><?= $site->namaweb?> - Resend Email Activation</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div id="app">
      ...
      // Form open 
      echo form_open(base_url('loginmember/resend_activation'));
       ?>
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-6">
            <button type="submit" class="btn btn-primary btn-block btn-lg">Send Activation</button>
          </div>
          <div class="col-6">
                <a href="<?php echo base_url('loginmember'); ?>" class="btn btn-info btn-block btn-lg"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
          </div>
          <!-- /.col -->
        </div>

<div class="row">
	<div class="col-md-7">
		<h4 class="alert alert-warning">Update Profil Anda</h4>
		...
		<?php echo form_open_multipart(base_url('member/akun'),'id="tambah"') ?>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<div class="form-group btn-group text-right">
					<button type="submit" name="submit" class="btn btn-danger btn-lg"><i class="fa fa-save"></i> Simpan Data</button>
					<button type="reset" name="reset" class="btn btn-warning btn-lg"><i class="fa fa-cut"></i> Reset</button>
					<a href="<?php echo base_url('member/dasbor') ?>" class="btn btn-success btn-lg" data-dismiss="modal"><i class="fa fa-times"></i> Kembali</a>
				</div>
			</div>
		</div>
	...
	<div class="col-md-5">
		<h4 class="alert alert-warning">Ganti Password</h4>



		<?php echo form_open_multipart(base_url('member/akun/password'),'id="tambah"') ?>

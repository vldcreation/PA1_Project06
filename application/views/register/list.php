      ...
      echo form_open(base_url('registrasi'));
       ?>
        ...
        <div class="form-group">
          <input type="text" name="member_name" class="form-control" placeholder="Nama Lengkap">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <input type="username" name="member_username" class="form-control" placeholder="Username">
        </div>
        <div class="form-group">
